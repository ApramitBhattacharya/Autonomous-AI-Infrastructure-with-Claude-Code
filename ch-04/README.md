...
|-----------|------------|-----------|
| `genesis/` | [`Sayfan-AI/genesis`](https://github.com/Sayfan-AI/genesis) - the bootstrapper that scaffolds autonomous dev systems | `v0.2` |
| `MaKlaude/` | [`Sayfan-AI/MaKlaude`](https://github.com/Sayfan-AI/MaKlaude) - the dev system genesis bootstraps, for autonomous Kubernetes operations | `v0.2` |

**End state:** Milestone 1 complete: the read-only foundation, shipped and verified.
