# Chapter 5 - Human Interaction - Staying Outside the Loop Without Losing Control
...
|-----------|------------|-----------|
| `genesis/` | [`Sayfan-AI/genesis`](https://github.com/Sayfan-AI/genesis) - the bootstrapper that scaffolds autonomous dev systems | `v0.2` (unchanged from the previous chapter) |
| `MaKlaude/` | [`Sayfan-AI/MaKlaude`](https://github.com/Sayfan-AI/MaKlaude) - the dev system genesis bootstraps, for autonomous Kubernetes operations | `v0.3` |

**End state:** Human-in-the-loop steering: comms channels and escalation.
