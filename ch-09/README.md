# Chapter 9 - Evaluation and Chaos Engineering - Kaos Monkey
...
|-----------|------------|-----------|
| `genesis/` | [`Sayfan-AI/genesis`](https://github.com/Sayfan-AI/genesis) - the bootstrapper that scaffolds autonomous dev systems | `v0.5` |
| `MaKlaude/` | [`Sayfan-AI/MaKlaude`](https://github.com/Sayfan-AI/MaKlaude) - the dev system genesis bootstraps, for autonomous Kubernetes operations | `v0.6` |

**End state:** Evaluation and chaos: the replay harness, action-correctness scoring, and Kaos Monkey at both levels.
...
**Chaos Mesh**, installed into the KinD cluster. Use MaKlaude's own installer rather than a manual `helm install`, so you get the pinned chart version the chapter was written against:
...
The chaos suites skip themselves when their kubeconfig is unset, so the rest of the end-to-end tests run fine without it.
